...
import { Cat, Dog, Rabbit, Star, Tag, ShieldCheck, Truck, CreditCard, MessageCircle, Stethoscope, Scissors, Hotel, PawPrint, CalendarDays, ShoppingBag, Lock, Users } from 'lucide-react';
        ...
        <div style={s.heroContent}>
          ...
          <div style={s.heroBtns}>
            ...
            >
              ...
              <span>
                <span style={s.btnMain}>Belanja Sekarang</span>
                <span style={s.btnSub}>500+ produk tersedia</span>
              </span>
          ...
          <div style={s.heroStats}>
            ...
            <div style={s.heroStatDivider} />
            <div style={s.heroStat}><strong style={s.heroStatNum}>4.9★</strong><span style={s.heroStatLabel}>Rating Toko</span></div>
          </div>
          ...
          <div style={s.promoGrid}>
            <div style={{ ...s.promoCard, background: 'linear-gradient(135deg,#ff6b35,#ff9a6c)' }}>
              <div>
                ...
                <button style={s.promoBtn} onClick={() => navigate('/products?hewan=kucing')} className="promo-btn-orange">Belanja Sekarang</button>
              </div>
      ...
      <div className="section-tight section-white">
        <div className="container">
          ...
          <div style={s.testiGrid}>
            {[
              { stars: '★★★★★', text: '"PawMart jadi andalan buat beli makanan si Oreo. Pengiriman cepet banget, produknya original. Recommended!"', initials: 'SR', name: 'Sari R.', sub: 'Pemilik 2 kucing', color: '#2d7a4f' },
              { stars: '★★★★★', text: '"Grooming-nya bagus banget! Anjingku jadi wangi sehari penuh. Groomernya sabar & profesional. Pasti balik lagi!"', initials: 'BD', name: 'Budi D.', sub: 'Pemilik Golden Retriever', color: '#f59e0b' },
              { stars: '★★★★☆', text: '"Nitip kelinci 3 hari pas liburan, alhamdulillah aman. Update foto tiap hari dari staf. Hati tenang liburannya!"', initials: 'AN', name: 'Ani N.', sub: 'Pemilik kelinci', color: '#8b5cf6' },
            ].map(t => (
              <div key={t.name} style={s.testiCard}>
                <div style={s.testiStars}>{t.stars}</div>
...
return (
    <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '13px', color: '#9ca3af', marginTop: '8px' }}>✦ Drag kartu untuk mengubah urutan</p>
        </div>
