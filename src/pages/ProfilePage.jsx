...
import {
  PawPrint, User, MapPin, Lock, ShoppingBag, Scissors,
...
/* ─── INPUT COMPONENT ───────────────────────────────────── */
function Input({ value, onChange, placeholder, type = "text", disabled, suffix }) {
        ...
        <div style={{ width: 250, flexShrink: 0 }}>
          ...
          <div style={{
            ...
            <span style={{
              ...
              fontSize: 11, fontWeight: 700, border: "1px solid #a8e6c3",
            }}>✦ Customer</span>
          </div>
                  ...
                  <div key={addr.id} style={{
                    ...
                    {addr.isDefault && (
                      <span style={{
                        ...
                        padding: "3px 10px", borderRadius: 20, letterSpacing: ".5px",
                      }}>✦ UTAMA</span>
                    )}
